...
--Create a stored procedure with a transaction to handle hiring
--a new employee. Add a new record for the employee in the
--Employees table and add a record to the Dealershipemployees
--table for the two dealerships the new employee will start at.
